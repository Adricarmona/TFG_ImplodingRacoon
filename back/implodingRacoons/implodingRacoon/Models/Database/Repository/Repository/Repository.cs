...
namespace implodingRacoon.Models.Database.Repository.Repository
{
    public abstract class Repository<TEntity, TId> : IRepository<TEntity, TId> where TEntity : class
    {
        protected readonly ImplodingRacoonsContext _context;

        public Repository(ImplodingRacoonsContext context)
        {
            _context = context;
        }
